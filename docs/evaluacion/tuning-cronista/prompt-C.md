...
del mismo pasaje. La cita acaba donde acaba lo copiado: no le añadas un punto final que el capítulo no tiene justo ahí; en un inciso de diálogo entre rayas (`—Dijo ella—.`), copia el inciso sin rayas y sin punto. Antes de escribir el fichero, vuelve a buscar cada cita en el capítulo.
