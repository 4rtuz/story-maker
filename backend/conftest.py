...
def plantillas(tmp_path_factory: pytest.TempPathFactory) -> Path:
    """Los workspaces de la tarea 1.13b y demo-regalo (spec 0006), construidos una vez por sesión
    con el bucle real y agentes falsos. demo-24 es la instantánea de demo-terminado al cerrar el
    capítulo 7."""
